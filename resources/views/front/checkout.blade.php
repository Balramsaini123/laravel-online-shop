            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card payment-form ">
                        ...
                        <div class="">
                            <input checked type="radio" class="form-check-input" id="payment_method_one"
                                name="payment_method" value="cod">
                            <label class="form-check-label" for="payment_method_one">Cash On Delivery</label>
                        </div>

                        <div class="">
                            <input type="radio" class="form-check-input" id="payment_method_two" name="payment_method"
                                value="cod">
