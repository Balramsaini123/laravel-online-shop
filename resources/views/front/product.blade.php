                        ...
                        @foreach ($relatedProducts as $relatedProduct)
                            ...
                            <div class="card product-card">
                                ...
                                <div class="card-body text-center mt-3">
                                    <a class="h6 link" href="{{ route('front.product', $product->slug) }}">{{ $relatedProduct->title }}</a>
                                    <div class="price mt-2">
                                        <span class="h5"><strong>Rs. {{ $relatedProduct->price }}</strong></span>
                                        @if ($relatedProduct->compare_price > 0)
                                            <span class="h6 text-underline"><del>Rs.
                                                    {{ $relatedProduct->compare_price }}</del></span>
                                        @endif
                                    </div>
                                </div>
                            </div>
